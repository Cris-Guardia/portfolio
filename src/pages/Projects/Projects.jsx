...
function Projects(){
    return(
        <main className='projects'>
            <h2>Projets</h2>
            <ProjectCard 
                title={'Projet d’études : Conception d’un système de pilotage pour robot'}
                description={
                    <>
                 ...
                 photoUrl={'./Images/Robot-1.jpg'}
            />
            <ProjectCard 
                title={'Projet d’études : Système de pilotage de drone.'}
                description={
                    <>
                ...
                photoUrl={'./Images/Drone1.jpg'}
                    // <img src='./Images/Drone2.jpg' alt='Drone Tello' />

            />
            
            <ProjectCard 
                title={'Projet d’études : Soudure de carte électronique.'}
                description={
                    <>
                        Projet qui consistait à l’organisation et à la soudure des composants sur une carte électronique
                        ayant pour but de faire varier la luminosité d’une LED à l’aide d’un potentiomètre.
                        ...
                        Ce projet m’a formé en soudure électronique et sur les protocoles nécessaires pour garantir un travail de qualité,
                        ainsi que sur la manipulation du matériel pertinent à la réalisation de ce travail.
                    </>
                }
                photoUrl={'./Images/Soudure.jpg'}
                    // <img src='./Images/Drone2.jpg' alt='Drone Tello' />
            />
            
            <ProjectCard 
                title={"Projet d’études : Conception d'une carte électronique."}
                description={
                    <>
                ...
                photoUrl={'./Images/Carte-schema1.png'}
                    // <img src='./Images/Drone2.jpg' alt='Drone Tello' />
            />

            {/* <img src='./Images/Carte-schema1.png' alt='Diagram of the card' />
            <img src='./Images/Carte-schema2.png' alt='Diagram of the card' />
            <img src='./Images/Carte-top.png' alt='Top view of the card created' />
            <img src='./Images/Carte-bottom.png' alt='Bottom view of the card created' />
            <img src='./Images/Carte-composants.png' alt='Composants view of the card created' /> */}
